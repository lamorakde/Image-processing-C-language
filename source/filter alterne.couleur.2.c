  ...
  for(j=1;j<dimx-1;j++)
{
    ...
    for (l=-1;l<2;l++)
        for (m=-1;m<2;m++)
    {
        if ( (ior[(i+l)*dimx+j+m])>max )
        {
            max=ior[(i+l)*dimx+j+m];
        }
    }
    it1[i*dimx+j]=max;            //取最大，做膨胀运算
}
  ...
  for(j=2;j<dimx-3;j++)
{
    ...
    irr[i*dimx+j]=max;            //取最小，做腐蚀运算,erosion，完成闭运算
}
  ...
  for(j=1;j<dimx-1;j++)
{
    ...
    for (l=-1;l<2;l++)
        for (m=-1;m<2;m++)
    {
        if ( (iov[(i+l)*dimx+j+m])>max )
        {
            max=iov[(i+l)*dimx+j+m];
        }
    }
    it1[i*dimx+j]=max;            //取最小，做腐蚀运算,erosion
}
  ...
  for(j=2;j<dimx-3;j++)
{
    ...
    irv[i*dimx+j]=max;            //取最小，做腐蚀运算,erosion，完成闭运算
}
  ...
  for(j=1;j<dimx-1;j++)
{
    ...
    for (l=-1;l<2;l++)
        for (m=-1;m<2;m++)
    {
        if ( (iob[(i+l)*dimx+j+m])>max )
        {
            max=iob[(i+l)*dimx+j+m];
        }
    }
    it1[i*dimx+j]=max;            //取最小，做腐蚀运算,erosion
}
  ...
  for(j=2;j<dimx-3;j++)
{
    ...
    irb[i*dimx+j]=max;            //取最小，做腐蚀运算,erosion，完成闭运算
}
